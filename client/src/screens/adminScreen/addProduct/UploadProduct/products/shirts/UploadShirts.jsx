...
import {
  addExistingShirtsVariantService,
  postShirtsProductService,
} from "../../../../../../api/adminServices/addProductService";
import presentToast from "../../../../../../components/Toast/Toast";
import { getShirtsProductsService } from "../../../../../../api/userServices/productsServices";
...
const UploadShirts = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (productType === "new") {
        response = await postShirtsProductService(formData);
        console.log(response, "res");
      } else {
        response = await addExistingShirtsVariantService(
          selectedProductId,
          formData,
        );
    ...
    <>
      <div className="my-page-container">
        <div className="uploadpage-container">
          <h2 className="uploadpage-title">Upload Shirts Product</h2>
          ...
          <div className="my-inventory-section">
            <h3 className="uploadpage-section-title">Size & Quantity</h3>

            <div
              className="pants-size-grid"
